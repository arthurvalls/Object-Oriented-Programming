...
public class ContaTest {
    ...
    @Test
    public void testJurosEResgatar(){
        Correntista Arthur = new Correntista("Arthur",002);
        Conta contadoArthur = new Conta(001,Arthur);
        ContaInvestimento contaInvestimentoArthur = new ContaInvestimento(123,Arthur,"Poupança",1.30f);
        contadoArthur.receberDepositoEmDinheiro(10000);
        contadoArthur.efetuarTransferecia(contaInvestimentoArthur,10000);
        assertEquals("Espera-se que tenha 13013",13013, contaInvestimentoArthur.aplicarJuros(),FLOAT_DELTA);
        contaInvestimentoArthur.resgatarTotal(contadoArthur);
        assertEquals("Espera-se que tenha 0",0, contaInvestimentoArthur.getSaldoEmReais(),FLOAT_DELTA);
    }
}
//    @Test
